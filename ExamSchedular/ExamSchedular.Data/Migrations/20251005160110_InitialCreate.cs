        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeatGroupSize = table.Column<int>(type: "integer", nullable: false),
                    DepartmentId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExamAssignmentId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ExamId = table.Column<int>(type: "integer", nullable: false),
                    TimeslotId = table.Column<int>(type: "integer", nullable: false),
                    ClassroomId = table.Column<int>(type: "integer", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamAssignments", x => x.ExamAssignmentId);
                    table.ForeignKey(
                        name: "FK_ExamAssignments_Classrooms_ClassroomId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExamAssignments_Timeslots_TimeslotId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColNum = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeatAssignments", x => x.SeatAssignmentId);
                    table.ForeignKey(
                        name: "FK_SeatAssignments_ExamAssignments_ExamAssignmentId",
                        column: x => x.ExamAssignmentId,
                        principalTable: "ExamAssignments",
                        principalColumn: "ExamAssignmentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamAssignments_TimeslotId",
                table: "ExamAssignments",
                column: "TimeslotId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeatAssignments_ExamAssignmentId",
